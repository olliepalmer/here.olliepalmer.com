// genres and subjects
var genre = ["a western","a noir","a neo noir","a coming-of-age film","thriller","a psychological thriller","a soap opera","a horror","a children’s film","an animal journey","a courtroom drama","a docudrama","a fly-on-the-wall documentary","a musical","magical realism","a procedural drama","a mockumentary","a slapstick film","a cooking show","an educational video","a game show","an infomercial","an advertisement","a corporate instructional film","a news report","a news segment","a magazine show","a stand up comedy film","a talk show","a kung fu film","an epic saga","a road movie","a music video"]
var subject = ["love story","dream sequence","overcoming the monster","rags to riches","quest","voyage and return","comedy","argument","rebirth","tragedy","adventure","rescue","escape","riddle","rivalry","underdog","sacrifice","forbidden love","metamorphosis","pursuit","disaster","revolt","vengeance","madness","loss","traveller's tale","creation myth","fable","farce","joke","urban legend"]
